...
from common.models import Address, User, Document, Comment, APISettings, Currency
...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['email', 'first_name', 'last_name',
                  ...
                  'has_sales_access', 'has_marketing_access','has_service_access']
    ...
    def clean_has_sales_access(self):
        ...
        if self.request_user.role == 'ADMIN' or self.request_user.is_superuser:
            if not is_admin:
                ...
                service = self.data.get('has_service_access',False)
                if not sales and not marketing and not service:
    ...
    def clean_has_service_access(self):
        service = self.cleaned_data.get('has_service_access', False)
        if self.request_user.role == 'USER':
            service = self.instance.has_service_access
        return service
