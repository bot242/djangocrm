...
class LeadForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.data.get('status') == 'Qualified':
            self.fields['account_name'].required = True
            self.fields['email'].required = True
        self.fields['first_name'].required = False
        self.fields['last_name'].required = False
        self.fields['title'].required = True
        if self.data.get('status') == 'Unqualified':
            self.fields['reason_for_unqualified_lead'].required = True
        if assigned_users:
    ...
    class Meta:
        ...
        fields = ('assigned_to', 'first_name',
                  ...
                  'website', 'description',
                  'address_line', 'street',
                  'city', 'state', 'postcode', 'country','reason_for_unqualified_lead'
                  )
