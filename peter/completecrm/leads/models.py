...
from common.utils import (COUNTRIES, LEAD_SOURCE, LEAD_STATUS,REASON_FOR_LEAD,
...
class Lead(models.Model):
    ...
    reason_for_unqualified_lead = models.CharField(_("Reason for lead"),max_length=255,blank=True,null=True,choices=REASON_FOR_LEAD)
    class Meta:
        ordering = ['-created_on']
