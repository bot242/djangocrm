...
class Contact(models.Model):
    ...
    phone1 = models.CharField(max_length=11,null=True, unique=True)
    phone2 = models.CharField(max_length=11,null=True, unique=True)
...
class Multimail(models.Model):
    category = models.ForeignKey(Contact,on_delete=models.CASCADE)
...
class Emailinfo(models.Model):
    ...
    from_address = models.EmailField(max_length = 50,default="")
    to_address = models.EmailField(max_length = 50,default="")
