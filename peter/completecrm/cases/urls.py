...
from cases.views import (
    ...
    AddAttachmentView, DeleteAttachmentsView,create_sla,create_slaemail,allsla,slalist,allslalist,allslaedit,allsladel,notifistatus,update_sla,changelog)
...
#     path('',dashboardCase, name='dash'),
    ...
    path('notifistatus/',notifistatus,name='notifistatus'),
