...
from common.views import (
    DashboardView,CaseDashboardView,HomeView, LoginView, ForgotPasswordView, LogoutView, IndvCaseDashboardView,SalesIndividual,
    ...
    activate_user, resend_activation_link, currency_settings
)
...
urlpatterns = [
    ...
    path('api/currency_setting', currency_settings, name="currency_setting"),
